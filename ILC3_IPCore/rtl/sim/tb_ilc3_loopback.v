...
//======================================================
// ILC3 0-code TX/RX Loopback Simple Testbench (BASELINE)
//
// Purpose:
//   - Verify basic TX/RX datapath of ILC3 0-code implementation.
//   - Fixed pattern 0,1,2,3,... under an ideal (noise-free) channel.
//   - Check 1-symbol pipeline latency in RX and scoreboard matching.
//
// Channel configuration:
//   - ilc3_channel_model with:
//       AMP_WIDTH = 4
//       GAIN_NUM  = 1
//       GAIN_DEN  = 1
//       OFFSET    = 0
//       ADD_NOISE = 0  (noise-free baseline)
//
// Test configuration:
//   - N_SYM = 1024 symbols.
...
//
// Expected:
//   - "RESULT = PASS" with err_cnt = 0 when ADD_NOISE=0.
//
//   This testbench is intended as the clean baseline for IPCore
//   documentation and regression, before adding noise / ISI / FEC.
//======================================================
...
module tb_ilc3_loopback;
    ...
    // - Channel is currently configured as ideal gain/offset,
    //   with ADD_NOISE=0 (noise-free baseline).
    //   For noise-injected tests, this parameter can be changed
    //   in a separate testbench (e.g., tb_ilc3_loopback_noise).
    //==================================================
    ilc3_channel_model #(
        .AMP_WIDTH(4),
        .GAIN_NUM (1),
